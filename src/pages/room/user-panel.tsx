...
const UserPanle: React.FC<{
  ...
  return (
    <>
      <div className="flex max-h-full items-center justify-between px-4 py-2 text-lg whitespace-nowrap">
        <h3>Participants (2)</h3>
        <button className="btn btn-remove-focus btn-text" onClick={handleClose}>
          <XMarkIcon className="h-5 w-5" />
        </button>
      </div>
      <div className="flex h-full flex-shrink flex-col gap-3 overflow-auto p-4 overflow-x-hidden">
        <UserItemCard />
      </div>
